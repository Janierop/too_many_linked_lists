...
mod test {
    ...
    /* This file contains the original code by the author of
    https://rust-unofficial.github.io/too-many-lists where they
    overlooked a mistake in their implementation of cursor::split_before()
    and cursor::split_after() which is why it fails this test. */
    #[test]
